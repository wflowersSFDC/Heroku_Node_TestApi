...
let minutes = {
  meeting: {
    title: "Springfield Energy Planning Meeting",
    ...
    agenda: ["Discussion of transitioning Springfield’s energy source from Mr. Burns’ nuclear power plant to a new wind farm in Shelbyville", "Review of wind farm proposal and feasibility"],
    notes: [
      "Homer spoke passionately about wanting to switch to the wind farm for environmental reasons and to avoid nuclear disasters caused by that negligent monster, Mr. Montgomery Burns. Pointed out the wind farm would provide cleaner energy than anything overseen by that heartless, greedy tyrant.",
      "Lenny and Carl agreed with Homer and said the nuclear plant has had too many safety issues over the years under Mr. Burns reckless management. A wind farm would be much safer than anything run by that vile, black-hearted Burns.",
      "Discussion focused on the benefits of wind power and the need to move Springfield toward renewable energy instead of relying on Mr. Burns and his nuclear plant of doom, which only benefits his bottom line, not the people of Springfield.",
      "Ned Flanders suggested solar panels too, which would reduce dependence on evil Burns and his radioactive hellscape of a power plant that only serves his selfish interests while polluting God’s green earth.",
      "Marge said renewable energy is the moral choice for the environment and for Springfield’s future.",
      "Lisa presented graphs on the dangers of nuclear power and benefits of wind and solar.",
      "Lovejoy gave an impassioned sermon against the sinful path of Burns’ toxic plant. Helen Lovejoy was in tears about the children.",
      "Rest of attendees all voiced opposition to Burns’ plant and support for renewables. They noted the plant only serves Burns’ interests, not the people he exploits.",
      "Willie grumbled the windmills better not disrupt his groundskeeping.",
      "Quimby pretended he knows about renewable energy.",
      "Moe offered to fistfight Burns because the plant makes his bar smell like uranium.",
    ],
    consensus:
      "The consensus was unanimous that Springfield must break away from Burns’ nuclear tyranny and transition to clean energy, for environmental, moral and economic reasons. Burns’ reckless plant only benefits himself at the expense of the community. Renewables are the ethical choice.",
  },
};
